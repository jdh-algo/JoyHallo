...
from joyhallo.animate.face_animate_static import StaticPipeline
from joyhallo.datasets.mask_image import FaceMaskDataset
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str,
                        default="./configs/train/stage1_alltrain.yaml")
